        ...
        <>
            ...
            <div className = "relative min-h-[calc(100vh-var(--nav-height))] w-full flex items-center justify-center px-4 py-8 font-[Poppins,sans-serif] antialiased">
                <div className = "relative z-10 w-full rounded-[28px] overflow-hidden
                                   ...
                                   md:max-w-[1024px] md:min-h-[600px] md:pb-0 md:pt-0"
                >
                    ...
                    <div className = "relative flex w-full">
                        {/* Login Container */}
                        <div className = {`w-full shrink-0 items-center justify-center py-8 z-10 md:w-1/2 md:flex ${
                            isRegisterActive ? "hidden" : "flex"
                        }`}>
                            <Login showMobileToggle = {isMobile} />
                        </div>
                        ...
                        <div className = {`w-full shrink-0 items-center justify-center py-8 z-10 md:w-1/2 md:flex ${
                            ...
                            <Register showMobileToggle = {isMobile} mobile = {isMobile} />
                        </div>
                    </div>

                    {/* Desktop Overlay (Remains sliding on Desktop, entirely hidden on Mobile) */}
                    <div className = {`hidden md:block absolute top-0 left-1/2 w-1/2 h-full z-20 overflow-hidden transition-transform duration-700 ease-in-out ${
