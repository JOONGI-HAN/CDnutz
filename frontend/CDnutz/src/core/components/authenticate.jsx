    ...
    return (
        <>
            ...
            <div className = "relative min-h-[calc(100vh-var(--nav-height))] w-full flex items-center justify-center px-4 py-8 font-[Poppins,sans-serif] antialiased">
                ...
                <div className = "fixed inset-0 z-0 overflow-hidden bg-[var(--primary-background)] pointer-events-none">
                    <div className = "absolute -top-[30%] -left-[10%] w-[70%] h-[70%] rounded-full
                                       bg-[radial-gradient(circle,rgba(168,85,247,0.45)_0%,rgba(147,51,234,0.22)_35%,rgba(88,28,135,0.08)_60%,transparent_80%)]
                                       blur-[110px] mix-blend-screen" />
                    <div className = "absolute -bottom-[30%] -right-[15%] w-[75%] h-[75%] rounded-full
                                       bg-[radial-gradient(circle,rgba(139,92,246,0.4)_0%,rgba(124,58,237,0.2)_40%,rgba(76,29,149,0.06)_65%,transparent_80%)]
                                       blur-[110px] mix-blend-screen" />
                    <div className = "absolute top-[8%] right-[12%] w-[45%] h-[45%] rounded-full
                                       bg-[radial-gradient(circle,rgba(216,180,254,0.3)_0%,rgba(192,132,252,0.12)_45%,transparent_75%)]
                                       blur-[90px] mix-blend-screen" />
                    <div className = "absolute bottom-[12%] left-[18%] w-[35%] h-[35%] rounded-full
                                       bg-[radial-gradient(circle,rgba(129,140,248,0.22)_0%,transparent_70%)]
            ...
            >
                {/* Glass sheen — faint light catching the top edge, reinforces the shadow-as-border */}
